    ...
    <section id="contact" className="py-20 md:py-28">
      <div className="max-w-4xl mx-auto px-6">
        <motion.div className="rounded-2xl border border-white/10 bg-white/5 p-8" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-2 text-sky-100/80">Tell us about your project and we’ll get back within 24 hours.</p>
          <div className="mt-6 grid md:grid-cols-2 gap-6 text-sky-100/90">
            <div>
            ...
            <div>
              <div className="text-sm uppercase tracking-widest text-sky-200/70">Availability</div>
